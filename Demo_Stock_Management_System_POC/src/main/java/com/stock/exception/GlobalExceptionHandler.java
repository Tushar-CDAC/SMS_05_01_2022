...
import com.stock.model.ApiErrors;

@ControllerAdvice
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {

	//proper http method is required (get,put,post etc)
	@Override
	...
	//proper use of content type (text,json)
	@Override
	...
	protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex,
		...
		String message = ex.getMessage();
		List<String> details = new ArrayList<>();
		details.add("Content is missing");
		ApiErrors errors = new ApiErrors(message, details, status, LocalDateTime.now());
		return ResponseEntity.status(status).body(errors);
	}
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public ResponseEntity<Object> handleWarehouseNotFoundException(WarehouseNotFoundexception ex){
		...
		String message = ex.getMessage();
		List<String> details = new ArrayList<>();
		details.add("Warehouse not found");
		ApiErrors errors = new ApiErrors(message, details, HttpStatus.BAD_REQUEST, LocalDateTime.now());
		return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(errors);
	}
	...
	public ResponseEntity<Object> handleLessStockException(LessStockException ex){
		
		String message = ex.getMessage();
		List<String> details = new ArrayList<>();
		details.add("Available stock is less than required.Please reduce the quantity");
		ApiErrors errors = new ApiErrors(message, details, HttpStatus.BAD_REQUEST, LocalDateTime.now());
		return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(errors);
	}
